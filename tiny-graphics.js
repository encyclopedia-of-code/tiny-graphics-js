...
export class Vertex_Buffer    // To use Vertex_Buffer, make a subclass of it that overrides the constructor and fills in the right fields.  
...
export class Graphics_State                                    // Stores things that affect multiple shapes, such as lights and the camera.
...
export class Shader            // Your subclasses of Shader will manage strings of GLSL code that will be sent to the GPU and will run, to
...
export class Texture                     // The Texture class wraps a pointer to a new texture buffer along with a new HTML image object.
